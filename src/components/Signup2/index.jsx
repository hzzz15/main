      ...
      <div className="signup2-content">
        ...
        <form className="signup2-form" onSubmit={handleNext}>
          <div className="signup2-form-group">
            <input type="text" id="username" placeholder="전화번호" className="login-input" required />
          </div>

          <div className="signup2-form-group">
            <input type="password" id="password" placeholder="내 주소" className="login-input" required />
          </div>
